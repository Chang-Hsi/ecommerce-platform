...
type CheckoutShippingInfoSectionProps = {
  deliveryWindowLabel?: string;
};

export function CheckoutShippingInfoSection({
  deliveryWindowLabel,
}: Readonly<CheckoutShippingInfoSectionProps>) {
  return (
    <section className="space-y-4 border-t border-zinc-200 pt-8">
      ...
      <div className="space-y-1">
        ...
        <p className="text-3xl text-zinc-700 sm:text-2xl">{deliveryWindowLabel || checkoutContent.shippingInfoDeliveryWindow}</p>
      </div>
    </section>
  );
}
